...
total_img = 1888  # 21957
validation_split_ratio = 0.15
max_train_img_size = int(train_task_id.split('T')[-1])
max_predict_img_size = int(train_task_id.split('T')[-1])  # 2400
print(max_predict_img_size)
print('+++++++++++++++++++++++++++++++++++++')
assert max_train_img_size in [256, 384, 512, 640, 768, 896, 1024, 1152, 1280, 1408, 1536, 736, 1664], \
...
data_dir = './data/'
origin_image_dir_name = 'shuiwei_1888/image/'
origin_txt_dir_name = 'shuiwei_1888/txt/'
...
shrink_ratio = 0.02 # 0.2
# pixels between 0.2 and 0.6 are side pixels
shrink_side_ratio = 0.06 # 0.6
epsilon = 1e-4
