...
if __name__ == '__main__':
    ...
    east_network.load_weights('./model/weights_jgz_jhz_longedge_T896.012-0.202.h5')
    east_network.save('./model/weights_jgz_jhz_longedge_T896.012-0.202_withgraph.h5')
