...
"""
def point_inside_of_quad(px, py, quad_xy_list, p_min, p_max):  # 判断是否是文本像素
    # 这个地方实际上判断的是否在最小外界矩形内部
