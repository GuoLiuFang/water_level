...
if __name__ == '__main__':
    model_path = './model/weights_table20200921SegmapT640.007-0.115.h5'
    east = East()
    east_network = east.east_network()
    east_network.summary()
    east_network.load_weights(model_path)
    east_network.save(model_path.replace('.h5', '_withgraph.h5'))
