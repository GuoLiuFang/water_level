...
image_root = '/water_workspace/ice_detection/train_images/'
gt_root = '/water_workspace/ice_detection/train_gts/'
...
def train(train_loader, model, optimizer, epoch):
    ...
    if opt.is_ResNet:
        save_path = 'model_1/CPD_Resnet/'
    else:
        save_path = 'model_1/CPD_VGG/'

    if not os.path.exists(save_path):
        os.makedirs(save_path)
    if (epoch+1) % 5 == 0:
        torch.save(model.state_dict(), save_path + 'CPD_{}.pth'.format(epoch+1))
